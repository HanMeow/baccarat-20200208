export default {
    data() {
        return {
            isInAppWebview: /micromessenger/i.test(navigator.userAgent) || /(FBAV|Line|FBAN)/.test(navigator.userAgent),
            isIos: /(iphone|ipad)/i.test(navigator.userAgent),
            isPad: /ipad/i.test(navigator.userAgent),
            ...
            IOSVersion: () => {
                if (this.isIos || this.isIosDesktop) {
                    const version =
